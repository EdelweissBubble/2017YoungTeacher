...
public class ScreenLBS extends BaseActivity implements AMapLocationListener {
	...
	private void init() {
		...
		locButton = (Button) findViewById(R.id.get_location);
		initBase(logView);
		NavigationBarUtils.initNavigationBar(this, naviBar, true, ScreenContents.class, false, ScreenLBS.class, false,
				ScreenContents.class);
	...
	public void onLocationChanged(AMapLocation arg0) {
		...
		if (arg0.getErrorCode() == 0) {
			...
			LogUtils.e("错误码：", "错误码：" + arg0.getErrorCode() + "");
			LogUtils.e("错误信息", "错误信息：" + arg0.getErrorInfo());
		}
	}
}